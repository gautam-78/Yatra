...
The following is a set of guidelines for contributing to Yatra, which is hosted on [Github](https://github.com/gautam-78/Yatra). These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.

# How Can I Contribute?

In order to discuss changes, you are welcome to [open an issue](https://github.com/gautam-78/Yatra/issues/new) about what you would like to contribute. Enhancements are always encouraged and appreciated.
